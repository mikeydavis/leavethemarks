...
exports.login=function(req,res){
    ...
    User.findOne({email:email}, function(err,user){
      ...
      if(user==null){
        console.log("user.js - login null  - User is null redirecting to login");
        var message="user.js - login null - Invalid email or password";
        console.log("user.js - login null - Message :"+message);
      ...
      user.comparePassword(password,function(err,isMatch){
       ...
       if(isMatch && isMatch==true){
         console.log('user.js - success - compare password');
         ...
         console.log('user.js - failed - compare password');
